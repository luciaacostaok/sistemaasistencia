...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Record de Asistencia</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					<input type="hidden" name="id" value="">
					<div class="row justify-content-center">
						<label for="" class="mt-2">Grado y Materia</label>
						<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>Por favor selecciona la clase.</i></h4></b></center>
						</div>
						<div class="col-md-12"  style="display: none" id="submit-btn-field">
							<center>
								<button class="btn btn-primary btn-sm col-sm-3" type="button" id="edit_att"><i class="fa fa-edit" data-id=''></i> Editar</button>
								<button class="btn btn-success btn-sm col-sm-3" type="button" id="print_att"><i class="fa fa-print"></i> Imprimir</button>
							</center>
						</div>
					</div>
				</form>
...
<div id="table_clone" style="display: none">
	<table width="100%">
		<tr>
			<td width="50%">
				<p>Curso: <b class="course"></b></p>
				<p>Materia: <b class="subject"></b></p>
			</td>
			<td width="50%">
				<p>Clase: <b class="class"></b></p>
...
<div id="chk_clone" style="display: none">
	<div class="d-flex justify-content-center chk-opts">
		<div class="form-check form-check-inline">
		  ...
		  <label class="form-check-label present-lbl">Presente</label>
		</div>
		<div class="form-check form-check-inline">
		  <input class="form-check-input absent-inp" type="checkbox" value="0" readonly="">
		  <label class="form-check-label absent-lbl">Ausente</label>
		</div>
		<div class="form-check form-check-inline">
		  <input class="form-check-input late-inp" type="checkbox" value="2" readonly="">
		  <label class="form-check-label late-lbl">Tarde</label>
		</div>
	</div>
</div>
<style>

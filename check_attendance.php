...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Pasar Asistencia</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					...
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>Selecciona la Clase</i></h4></b></center>
						</div>
						<div class="col-md-12"  style="display: none" id="submit-btn-field">
							<center>
								<button class="btn btn-primary btn-sm col-sm-5">Guardar</button>
							</center>
						</div>
					</div>
				</form>
...
<div id="chk_clone" style="display: none">
	<div class="d-flex justify-content-center chk-opts">
		...
		<div class="form-check form-check-inline">
		  ...
		  <label class="form-check-label late-lbl">Justificación</label>
		</div>
	</div>
</div>
<style>
